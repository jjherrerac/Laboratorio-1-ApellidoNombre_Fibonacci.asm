...
# Este programa permite al usuario ingresar entre 3 y 5 números y determina cuál es el mayor.
...
input_loop:
    bge $t3, $t0, find_max   # Si se han ingresado todos los números, salir del bucle
...
find_max:
    ...
    sw $t5, max_num          # Guardar el primer número como máximo inicial
...
max_loop:
    ...
    lw $t7, max_num          # Cargar el número mayor actual
    ble $t6, $t7, skip       # Si el número actual es menor o igual, omitir

    sw $t6, max_num          # Si el número actual es mayor, guardarlo como máximo
...
display_result:
    ...
    lw $a0, max_num          # Cargar el número mayor
